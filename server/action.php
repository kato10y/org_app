...
<body class="form_content">
    <div class="form_wrap">
        ...
        <form action="" method="post" class="forms">
            <div class="form_item">
                <label for="content" class="form_title">実施内容</label>
                <input type="text" name="content" id="content" required>
            </div>
            <div class="form_item">
                <label for="place" class="form_title">場所</label>
                <input type="text" name="place" id="place" required>
            </div>
            <div class="form_item form_date">
                <div>
                    <label for="start_time" class="form_title">開始時間</label>
                    <input type="datetime-local" name="start_time" id="start_time" required>
                </div>
                <div>
                    <label for="end_time" class="form_title">終了時間</label>
            ...
            <div class="form_reserve">
                ...
                <input type="text" name="reservation_person" id="reservation_person" placeholder="予約担当者名">
            </div>
            <div class="form_item">
